...
const products = [
  ...
  },
  {
    ...
    price: '$50',
    availability: 'White and Black',
    imageSrc: 'https://www.forlifedesignusa.com/cdn/shop/products/521-CAR.jpg?v=1582155776',
    imageAlt: 'White fabric pouch with white zipper, black zipper pull, and black elastic loop.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    price: '$220',
    availability: 'Blue',
    imageSrc: 'https://m.media-amazon.com/images/I/41m9XdsXEqL._AC_UF894,1000_QL80_.jpg',
    imageAlt:
      'Front of satchel with blue canvas body, black straps and handle, drawstring top, and front zipper pouch.',
  },
  // More products...
