      ...
      <main className="isolate">
        ...
        <div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <h2 className=" text-left text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our mission</h2>
        ...
        {/* Values section */}
        <div className="text-center mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
